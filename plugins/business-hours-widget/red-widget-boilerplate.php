 ...
 * @author    Tejaswini Kumar <tejaswinikumar94@gmail.com>
 * @license   GPL-2.0+
 * @link      http://example.com
 * @copyright 2020 Tejaswini Kumar
 *
 * @wordpress-plugin
...
class business_hours extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'widget to show business hours.'
			)
		);
	...
	public function widget( $args, $instance ) {
		...
		$Weekends = empty( $instance['Weekends'] ) ? '' : apply_filters( 'Weekdays', $instance['Weekends'] );
		$Saturdays = empty( $instance['Saturdays'] ) ? '' : apply_filters( 'Saturdays', $instance['Saturdays'] );
		$Sunday = empty( $instance['Sunday'] ) ? '' : apply_filters( 'Sundays', $instance['Sunday'] );
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['Weekends'] = strip_tags( $new_instance['Weekends'] );
	...
	public function form( $instance ) {
		...
		$Weekends = strip_tags( $instance['Weekends'] );
